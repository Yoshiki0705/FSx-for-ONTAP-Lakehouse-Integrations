...
| **How this is reported** | Written up here rather than as a support case: this account has no Help Center access (confirmed 2026-08-12, and a 2026-05 case was closed on the same grounds). The write-up is deliberately reproducible so the finding does not depend on a support channel |
